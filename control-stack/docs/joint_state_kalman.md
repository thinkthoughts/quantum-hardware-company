...
![joint worst case](../figures/joint_state_kalman/05_joint_state_kalman_worst_case.png)
...
![omega error](../figures/joint_state_kalman/05_joint_state_kalman_omega_error.png)
...
![b error](../figures/joint_state_kalman/05_joint_state_kalman_b_error.png)
...
![readout offset](../figures/joint_state_kalman/05_joint_state_kalman_readout_offset.png)
...
![rabi estimate](../figures/joint_state_kalman/05_joint_state_kalman_rabi_estimate.png)
...
![response error](../figures/joint_state_kalman/05_joint_state_kalman_response_error.png)
...
![policy ranking](../figures/joint_state_kalman/05_joint_state_kalman_policy_ranking.png)
...
![phase lock](../figures/joint_state_kalman/05_joint_state_kalman_phase_lock.png)
